...
public class GetByConditionAsyncTests : GivenWhenAsyncThenTest
{
    ...
    {
        _resultEntities = (await _sut.GetByConditionAsync(entity => entity.Name == "Test 1")).ToList();
    }
    ...
    public void Then_It_Should_Not_Include_Related_Entities()
    {
        ...
        _resultEntities.ForEach(entity => entity.TestRelatedEntities.Should().BeEmpty());
    }
}
